...
|-----------------:|:-----------------------------|:-----------------|-----------------:|-------------------:|------------------------------------:|--------------------------:|
|                1 | random-train_20260526_161408 | dual_experiments |               60 |                 60 |                                   1 |                   49.6556 |
...
|:-----------------------------|:-----------------|--------------------:|-------------------:|------------------------------------:|:------------------------------|:------------------------------------------------------------------------------------------|
| random-train_20260526_161408 | dual_experiments |                   1 |                 60 |                                   1 | True                          | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses;selected_for_aggregate |
| random-train_20260526_161144 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_160919 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_160655 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_160431 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_160207 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_155943 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_155719 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_155455 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |
| random-train_20260526_155231 | dual_experiments |                   1 |                 60 |                                   1 | False                         | full_video_coverage;perfect_windowed_coincidence;10_matched_pulses                        |

## Artefactos generados

- `avg_flash_frame.png`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/avg_flash_frame.png`
- `flash_heatmap.png`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/flash_heatmap.png`
- `reconstruction_comparison_panel.png`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/reconstruction_comparison_panel.png`
- `coincidence_offset_distribution.png`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/coincidence_offset_distribution.png`
- `reconstruction_statistics.csv`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/reconstruction_statistics.csv`
- `reconstruction_confidence_notes.md`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/reconstruction_confidence_notes.md`
- `reconstruction_uncertainty_summary.md`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/reconstruction_uncertainty_summary.md`
- `pulse_strips/`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/pulse_strips`
- `slowmo_frames/`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/slowmo_frames`
- `slowmo_reconstruction.gif`: `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0/slowmo_reconstruction.gif`
...
- Offset medio con incertidumbre temporal: `49.7 +/- 20.1 ms from interval-based propagation of mean frame half-period and OP598 half sample-interval`
...
Todos los outputs se escriben en `data/derived/reconstruction-camera0/new-camera-mount-20260526-camera0`.
