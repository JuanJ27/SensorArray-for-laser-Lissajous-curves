...
Pulsos acumulados en la reconstruccion: `30`.
ESS pooled entre corridas: `3.00`.
Coincidencia pooled: `1.000` con IC95% `[0.886, 1.000]`.

## Corridas elegidas

|   selection_rank | run_id                       | variant                                  |   covered_pulses |   matched_detected |   coincidence_success_rate_windowed |   mean_offset_ms_detected |
|-----------------:|:-----------------------------|:-----------------------------------------|-----------------:|-------------------:|------------------------------------:|--------------------------:|
|                1 | random-train_20260522_172025 | phase2_statistical_reconstruction_matrix |               10 |                 10 |                                   1 |                   39.4449 |
|                2 | random-train_20260522_163706 | phase2_statistical_reconstruction_matrix |               10 |                 10 |                                   1 |                   32.1117 |
|                3 | random-train_20260522_162947 | phase2_statistical_reconstruction_matrix |               10 |                 10 |                                   1 |                   39.397  |
...
|:-----------------------------|:-----------------------------------------|--------------------:|-------------------:|------------------------------------:|:------------------------------|:---------------------------------------------------------------------------------------------------------|
| random-train_20260522_172025 | phase2_statistical_reconstruction_matrix |               1     |                 10 |                            1        | True                          | full_video_coverage;perfect_windowed_coincidence;matrix_variant;10_matched_pulses;selected_for_aggregate |
| random-train_20260522_163706 | phase2_statistical_reconstruction_matrix |               1     |                 10 |                            1        | True                          | full_video_coverage;perfect_windowed_coincidence;matrix_variant;10_matched_pulses;selected_for_aggregate |
| random-train_20260522_162947 | phase2_statistical_reconstruction_matrix |               1     |                 10 |                            1        | True                          | full_video_coverage;perfect_windowed_coincidence;matrix_variant;10_matched_pulses;selected_for_aggregate |
| random-train_20260522_155230 | phase2_statistical_reconstruction_probe  |               1     |                  4 |                            0.8      | False                         | full_video_coverage                                                                                      |
| random-train_20260522_155351 | phase2_statistical_reconstruction_matrix |               1     |                  6 |                            0.6      | False                         | full_video_coverage;matrix_variant                                                                       |
| random-train_20260522_155311 | phase2_statistical_reconstruction_matrix |               1     |                  5 |                            0.5      | False                         | full_video_coverage;matrix_variant                                                                       |
| random-train_20260522_162539 | phase2_statistical_reconstruction_matrix |               0.125 |                  5 |                            0.333333 | False                         | matrix_variant                                                                                           |
| random-train_20260522_155431 | phase2_statistical_reconstruction_matrix |               1     |                  0 |                            0        | False                         | full_video_coverage;matrix_variant                                                                       |
| random-train_20260522_155022 | phase2_statistical_reconstruction        |               1     |                  0 |                            0        | False                         | full_video_coverage                                                                                      |
| random-train_20260522_154927 | phase2_statistical_reconstruction        |               1     |                  0 |                            0        | False                         | full_video_coverage                                                                                      |
| random-train_20260522_155151 | phase2_statistical_reconstruction_probe  |               1     |                  0 |                            0        | False                         | full_video_coverage                                                                                      |

## Artefactos generados

- `avg_flash_frame.png`: `data/derived/reconstruction/avg_flash_frame.png`
- `flash_heatmap.png`: `data/derived/reconstruction/flash_heatmap.png`
- `reconstruction_comparison_panel.png`: `data/derived/reconstruction/reconstruction_comparison_panel.png`
- `coincidence_offset_distribution.png`: `data/derived/reconstruction/coincidence_offset_distribution.png`
- `reconstruction_statistics.csv`: `data/derived/reconstruction/reconstruction_statistics.csv`
- `reconstruction_confidence_notes.md`: `data/derived/reconstruction/reconstruction_confidence_notes.md`
- `reconstruction_uncertainty_summary.md`: `data/derived/reconstruction/reconstruction_uncertainty_summary.md`
- `pulse_strips/`: `data/derived/reconstruction/pulse_strips`
- `slowmo_frames/`: `data/derived/reconstruction/slowmo_frames`
- `slowmo_reconstruction.gif`: `data/derived/reconstruction/slowmo_reconstruction.gif`
...
- Offset medio con incertidumbre temporal: `37.0 +/- 20.1 ms from interval-based propagation of mean frame half-period and OP598 half sample-interval`
...
Todos los outputs se escriben en `data/derived/reconstruction`.
